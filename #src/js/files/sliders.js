...
if (document.querySelector(".footer-slider-unscrupulous-analyst__body")) {
  footerSliderAnalyst = new Swiper(
    ".footer-slider-unscrupulous-analyst__body",
    {
      observer: true,
      observeParents: true,
      slidesPerView: 1,
...
if (
  document.querySelector(".footer-slider-unscrupulous-analyst__body") &&
  document.querySelector(".slider-unscrupulous-analyst__body")
) {
